...
export default function ProductForm() {
    ...
    const handleSubmit = (e) => {
        ...
        const newDataWithUUID = { ...data, id: uuidv4(), productCategory: data.productCategory, productFreshness: data.productFreshness, productPrice: data.productPrice,}; // Generate UUID
        setData({
            productName: "", 
            productCategory: "", 
            productFreshness: "",
    ...
    return (
        <form className="col-8" onSubmit={handleSubmit} name="form-product">
            ...
            <div className="modal fade" id="exampleModal" tabIndex={-1} aria-labelledby="exampleModalLabel" aria-hidden="true" show={showModal}>
